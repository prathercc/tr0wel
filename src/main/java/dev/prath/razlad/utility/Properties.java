package dev.prath.razlad.utility;
...
public class Properties {
	...
	public static final Path iniPath = Paths.get(Paths.get(System.getProperty("user.home"), ".razlad").toString(),"razlad.ini");
	public static final Path iniFolderPath = Paths.get(System.getProperty("user.home"), ".razlad");
	public static final String sourceCodeLink = "https://github.com/aaprather/razlad";
	public static final String prathDevLink = "https://prath.dev/software/razlad";
